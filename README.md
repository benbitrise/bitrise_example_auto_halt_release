...
This gist explains how you can automate the halting of the rollout. Automating this means faster response time (fewer end-users experience the bug) and less toil checking on release health metrics.
